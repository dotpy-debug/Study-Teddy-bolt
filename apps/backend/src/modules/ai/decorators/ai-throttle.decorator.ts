 ...
 */
export const AIThrottle = (limit: number, ttl: number) => Throttle({ default: { limit, ttl } });
 ...
 */
export const AIChat = () => AIThrottle(DEFAULT_AI_LIMITS.chat.limit, DEFAULT_AI_LIMITS.chat.ttl);
...
export const AIPracticeQuestions = () =>
  AIThrottle(DEFAULT_AI_LIMITS.practiceQuestions.limit, DEFAULT_AI_LIMITS.practiceQuestions.ttl);
...
export const AIStudyPlan = () =>
  AIThrottle(DEFAULT_AI_LIMITS.studyPlan.limit, DEFAULT_AI_LIMITS.studyPlan.ttl);

/**
 * Heavy AI operations throttling: 2 requests per minute
 * For operations that consume significant AI resources
 */
export const AIHeavy = () => AIThrottle(DEFAULT_AI_LIMITS.heavy.limit, DEFAULT_AI_LIMITS.heavy.ttl);

/**
 * Light AI operations throttling: 20 requests per minute
 * For simple AI operations like stats or history
 */
export const AILight = () => AIThrottle(DEFAULT_AI_LIMITS.light.limit, DEFAULT_AI_LIMITS.light.ttl);
